...
from prime_rl.trainer.models.qwen3_next import Qwen3NextConfig, Qwen3NextForCausalLM
...
AutoConfig.register("qwen3_next", Qwen3NextConfig, exist_ok=True)
...
_CUSTOM_CAUSAL_LM_MAPPING.register(Qwen3NextConfig, Qwen3NextForCausalLM, exist_ok=True)
